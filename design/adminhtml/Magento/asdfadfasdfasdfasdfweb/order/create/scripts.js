...
define([
    ...
    AdminOrder.prototype = {
        ...
        hideArea : function(area){
            if(area == 'customer-selector'){
                console.log('In HideArea for customer-selector');
                console.log(this.customerId);
    ...
    jQuery( document ).ready(function() {
        if(typeof this.data !== 'undefined' || this.data !== null){
            ...
            jQuery('sales_order_create_customer_grid_table').show();          
        }else{
            console.log('Data Set');
            jQuery('sales_order_create_customer_grid_table').hide();
            //sales_order_create_customer_grid_table
        }
