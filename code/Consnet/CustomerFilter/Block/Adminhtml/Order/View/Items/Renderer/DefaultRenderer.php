 ...
 */
namespace Consnet\CustomerFilter\Block\Adminhtml\Order\View\Items\Renderer;
    ...
    public function getColumnHtml(\Magento\Framework\DataObject $item, $column, $field = null)
    {
        ...
        switch ($column) {
            case 'product':
                ...
                $html .= '<div id="' . $this->getHtmlId() . '">';
                $html .= $item->getName();//$this->getColumnHtml($item->getName(), 'name');
                $html .= '</div>';
                /*if ($this->canDisplayContainer()) {
                    $html .= '</div>';
                } */
