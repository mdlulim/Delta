...
class CronJobPromotion {
 ...
 private	$list = array();
    ...
    public function getMyListOfMatErp($stp_id) {
        ...
        $WURL = "http://deltadev01.delta.co.zw/sap/bc/srt/wsdl/flv_10002A101AD1/bndg_url/sap/bc/srt/rfc/sap/zz_magento_get_promo_wsdl_1/220/zz_magento_get_promo_wsdl_1/zz_magento_binding?sap-client=220";
...
//         }
              ...
              $model->setKnuma_promo($item->Knuma);
